...
<html lang="en">
<head>
  <title>Application Approved By University</title>
  <meta charset="utf-8">
...
<body style="font-family: 'Open Sans', sans-serif; line-height: 1.5;">
	<div style="max-width:650px; margin:15px auto; border: 1px solid #ccc;">
		...
		<div style="background:#fff; padding:20px; text-align:center;">
			<h3 style="margin-top: 10px; text-align:center; font-size: 21px; font-weight: normal; text-transform: uppercase;">Subject : Application Approved By University</h3>
			<div>{{$applicationsmessage}}</div>
