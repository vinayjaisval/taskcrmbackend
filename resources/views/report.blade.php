                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            c.total_time_assign
                            FROM tbl_lead_follow_timer a
                            JOIN tbl_lead c ON a.lead_id = c.id
                            JOIN tbl_users u ON c.project = u.id
                            WHERE a.user_id = '".$usr->id."'
                            AND (
                            a.updatetime BETWEEN '".date('Y-m-d 09:30:00')."' AND '".date('Y-m-d 11:30:00')."'
                            ...
                            @endphp
                            <div>
                                <strong>Project:</strong> {{ $d[0]->project_name }}
                            </div>

                            <div> <small>{{ $d[0]->name }}</small></div>
                        ...
                        <td>
                            ...
                            WHERE a.user_id = '".$usr->id."'
                            AND (
                            a.updatetime BETWEEN '".date('Y-m-d 11:30:00')."' AND '".date('Y-m-d 13:00:00')."'
                            ...
                            <div><strong>Project:</strong> {{ $d[0]->project_name }}</div>
                            <div>{{ $d[0]->name }}</div>
                        ...
                        <td>
                            ...
                            WHERE a.user_id = '".$usr->id."'
                            AND (
                            a.updatetime BETWEEN '".date('Y-m-d 14:00:00')."' AND '".date('Y-m-d 15:30:00')."'
                        ...
                        <td>
                            ...
                            WHERE a.user_id = '".$usr->id."'
                            AND (
                            a.updatetime BETWEEN '".date('Y-m-d 15:30:00')."' AND '".date('Y-m-d 17:00:00')."'
                        ...
                        <td>
                            ...
                            WHERE a.user_id = '".$usr->id."'
                            AND (
                            a.updatetime BETWEEN '".date('Y-m-d 17:00:00')."' AND '".date('Y-m-d 18:30:00')."'
